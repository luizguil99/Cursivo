...
export function ContinueStudying({ proximaAulaCallback, onCoursesClick }) {
    ...
    <div className="rounded-lg p-4 sm:p-6 mb-6 border bg-card/50 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center py-8 text-center">
          <div className="w-12 h-12 bg-[#F3C92C] rounded-full flex items-center justify-center shadow-lg shadow-[#F3C92C]/20 mb-4">
          ...
          <div className="space-y-2 mb-6">
            ...
            <p className="text-sm text-muted-foreground max-w-sm mx-auto">
              Comece sua jornada de aprendizado assistindo sua primeira aula
            </p>
          </div>
          <Button
            onClick={onCoursesClick}
            className="bg-[#F3C92C] hover:bg-[#F3C92C]/80 text-background shadow-lg shadow-[#F3C92C]/20"
          >
            Explorar Cursos
          </Button>
        </div>
          ...
          <div className="flex-1 min-w-0">
            <div className="flex flex-wrap items-center gap-2 mb-1">
              <h4 className="font-medium text-sm sm:text-base">
                {ultimaAulaVista.videoaulas.titulo}
              </h4>
